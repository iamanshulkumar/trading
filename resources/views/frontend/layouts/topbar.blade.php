<header class="main-header">
    <div class="d-flex align-items-center logo-box pl-20">
        <a href="#" class="waves-effect waves-light nav-link rounded d-none d-md-inline-block push-btn"
            ...
            <img src="https://crypto-tokenizer-admin-dashboard.multipurposethemes.com/bs4/images/svg-icon/collapse.svg"
                class="img-fluid svg-icon" alt="svg-icon" />
        </a>
        <!-- Logo -->
            ...
            <ul class="header-megamenu nav">
                ...
                <li class="btn-group nav-item">
                    <a href="#" data-provide="fullscreen"
                        ...
                        <img src="https://crypto-tokenizer-admin-dashboard.multipurposethemes.com/bs4/images/svg-icon/fullscreen.svg"
                            class="img-fluid svg-icon" alt="" />
                    </a>
                </li>
                            ...
                            <div class="input-group">
                                ...
                                <div class="input-group-append">
                                    <button class="btn" type="submit" id="button-addon2">
                                        <img src="https://crypto-tokenizer-admin-dashboard.multipurposethemes.com/bs4/images/svg-icon/search.svg"
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown notifications-menu">
                    <a href="#" class="waves-effect waves-light dropdown-toggle" data-toggle="dropdown"
                        title="Notifications">
                        <img src="https://crypto-tokenizer-admin-dashboard.multipurposethemes.com/bs4/images/svg-icon/notifications.svg"
                            class="img-fluid svg-icon" alt="" />
                    </a>
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="waves-effect waves-light dropdown-toggle" data-toggle="dropdown"
                        title="User">
                        <img src="https://crypto-tokenizer-admin-dashboard.multipurposethemes.com/bs4/images/svg-icon/user.svg"
                ...
                <li>
                    <a href="#" data-toggle="control-sidebar" title="Setting"
                        ...
                        <img src="https://crypto-tokenizer-admin-dashboard.multipurposethemes.com/bs4/images/svg-icon/settings.svg"
                            class="img-fluid svg-icon" alt="" />
                    </a>
                </li>
            </ul>
